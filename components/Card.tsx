...
export default function Card(props: CardProps) {
    const { data } = props;
    return (
        <div className="info-card flex flex-col justify-around items-center text-center w-full my-5 lg:my-0 mx-2 lg:mx-6 px-2 py-4 rounded-lg bg-gray-100 shadow-gray-200 shadow-lg">

    ...
    return (
        <nav className='sticky w-full top-0 left-0 border-b z-50 border-gray-200 bg-gray-50 shadow shadow-slate-200 rounded py-3'>
            <div className='flex flex-wrap justify-between items-center mx-auto'>
                ...
                <div onClick={openNavbar} className='hamburguer-menu-button flex justify-center items-center lg:hidden w-1/3'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-9 h-9 border-2 rounded-md shadow shadow-slate-600">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 5.25h16.5m-16.5 4.5h16.5m-16.5 4.5h16.5m-16.5 4.5h16.5" />
                    </svg>
                </div>

                <div className={'menu-buttons lg:flex lg:justify-center lg:items-center lg:w-1/3 w-full order-last lg:order-none ' + (isNavbarOpen ? '' : 'hidden')}>

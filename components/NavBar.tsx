            ...
            <div className='relative flex flex-wrap justify-between items-center mx-auto'>
                ...
                <div className={'menu-buttons bg-gray-100/70 lg:bg-transparent h-screen lg:h-full lg:flex lg:justify-center lg:items-center lg:w-1/4 w-full order-last lg:order-none ' + (isNavbarOpen ? '' : ' hidden')}>
                    <ul className={'block text-center mt-3 lg:mt-0 w-full lg:flex lg:flex-row lg:justify-around lg:items-center'}>
                        ...
                        <li onClick={toggleNavbar}>
                            <Link href='/canchas'>
                                <div className={'cursor-pointer w-1/2 lg:w-auto m-auto my-1 lg:my-0 px-5 py-1 text-slate-800 hover:text-slate-400 transition-all ' + (currentPage.pathname === '/canchas' ? "border rounded-2xl bg-slate-300 hover:text-slate-600" : "")}>CANCHAS</div>
                            </Link>
                        </li>
                        <li onClick={toggleNavbar}>
                            <Link href='/contacto'>
